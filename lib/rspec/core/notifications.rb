RSpec::Support.require_rspec_core "formatters/exception_formatter"
...
module RSpec::Core
  ...
  module Notifications
    ...
    class FailedExampleNotification < ExampleNotification
      ...
      def description
        @exception_formatter.description
      end
      ...
      def message_lines
        @exception_formatter.message_lines
      end
      ...
      def colorized_message_lines(colorizer=::RSpec::Core::Formatters::ConsoleCodes)
        @exception_formatter.colorized_message_lines(colorizer)
      end
      ...
      def formatted_backtrace
        @exception_formatter.formatted_backtrace
      end
      ...
      def colorized_formatted_backtrace(colorizer=::RSpec::Core::Formatters::ConsoleCodes)
        @exception_formatter.colorized_formatted_backtrace(colorizer)
      end

      # @return [String] The failure information fully formatted in the way that
      #   RSpec's built-in formatters emit.
      def fully_formatted(failure_number, colorizer=::RSpec::Core::Formatters::ConsoleCodes)
        @exception_formatter.fully_formatted(failure_number, colorizer)
      end

    private

      def initialize(example, exception_formatter=Formatters::ExceptionFormatter.new(example.execution_result.exception, example))
    ...
    private
      ...
      def initialize(example)
        super(example, Formatters::ExceptionFormatter.new(
